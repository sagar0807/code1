...
public interface TIOstPrescriptionFollowUpMapper {//extends EntityMapper<TIOstPrescriptionDTO, TiOstPrescription> {
	...
	@Mapping(source="followUpId",target="tiOstFollowUp.id")
