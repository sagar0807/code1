 ...
 */
@Mapper(componentModel = "spring", uses = { MMEducationLevelMapper.class,MMMaritalStatusMapper.class,BeneficiaryFamilyDetailsMapper.class,
		MMEmploymentStatusMapper.class,MMClientStatusMapper.class,BeneficiaryFacilityMapper.class,MMOccupationMapper.class,MMGenderMapper.class,
