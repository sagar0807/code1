...
/**
 * The persistent class for the art_beneficiary_coexisting_conditions database table.
 * 
 */
@Entity
...
public class ArtBeneficiaryCoexistingCondition implements Serializable {
