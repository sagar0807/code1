...
/**
 * The persistent class for the master_tb_treatment_status database table.
 * 
 */
@Entity
@Table(name="master_tb_treatment_status")
@NamedQuery(name="MasterTbTreatmentStatus.findAll", query="SELECT m FROM MasterTbTreatmentStatus m")
public class MasterTbTreatmentStatus implements Serializable {
	...
	@OneToMany(mappedBy="masterTbTreatmentStatus")
	private Set<ArtBeneficiaryIptAttDetail> artBeneficiaryIptAttDetails;

	public MasterTbTreatmentStatus() {
	}
	...
	public ArtBeneficiaryIptAttDetail addArtBeneficiaryIptAttDetail(ArtBeneficiaryIptAttDetail artBeneficiaryIptAttDetail) {
		...
		artBeneficiaryIptAttDetail.setMasterTbTreatmentStatus(this);
	...
	public ArtBeneficiaryIptAttDetail removeArtBeneficiaryIptAttDetail(ArtBeneficiaryIptAttDetail artBeneficiaryIptAttDetail) {
		...
		artBeneficiaryIptAttDetail.setMasterTbTreatmentStatus(null);
