...
/**
 * The persistent class for the master_functional_status database table.
 * 
 */
@Entity
@Table(name="master_functional_status")
@NamedQuery(name="MasterFunctionalStatus.findAll", query="SELECT m FROM MasterFunctionalStatus m")
public class MasterFunctionalStatus implements Serializable {
	...
	@OneToMany(mappedBy="masterFunctionalStatus")
	private Set<ArtBeneficiaryFollowup> artBeneficiaryFollowups;

	public MasterFunctionalStatus() {
	}
	...
	public ArtBeneficiaryFollowup addArtBeneficiaryFollowup(ArtBeneficiaryFollowup artBeneficiaryFollowup) {
		...
		artBeneficiaryFollowup.setMasterFunctionalStatus(this);
	...
	public ArtBeneficiaryFollowup removeArtBeneficiaryFollowup(ArtBeneficiaryFollowup artBeneficiaryFollowup) {
		...
		artBeneficiaryFollowup.setMasterFunctionalStatus(null);
