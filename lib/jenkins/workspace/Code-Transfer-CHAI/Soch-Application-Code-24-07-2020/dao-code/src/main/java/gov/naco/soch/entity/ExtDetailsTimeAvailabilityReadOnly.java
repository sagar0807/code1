...
@Entity(name="ExtDetailsTimeAvailabilityReadOnly")
@Table(name="ti_ext_details_time_availability_mapping")
@Where(clause="is_delete=false")
@Immutable
public class ExtDetailsTimeAvailabilityReadOnly  extends Auditable<Long> implements Serializable {
	...
	public ExtDetailsTimeAvailabilityReadOnly() {
