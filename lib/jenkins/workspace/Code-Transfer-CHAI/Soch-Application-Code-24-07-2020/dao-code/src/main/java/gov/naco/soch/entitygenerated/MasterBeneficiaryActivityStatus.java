...
/**
 * The persistent class for the master_beneficiary_activity_status database table.
 * 
 */
@Entity
@Table(name="master_beneficiary_activity_status")
@NamedQuery(name="MasterBeneficiaryActivityStatus.findAll", query="SELECT m FROM MasterBeneficiaryActivityStatus m")
public class MasterBeneficiaryActivityStatus implements Serializable {
	...
	@OneToMany(mappedBy="masterBeneficiaryActivityStatus")
	private Set<ArtBeneficiary> artBeneficiaries;

	public MasterBeneficiaryActivityStatus() {
	}
	...
	public ArtBeneficiary addArtBeneficiary(ArtBeneficiary artBeneficiary) {
		...
		artBeneficiary.setMasterBeneficiaryActivityStatus(this);
	...
	public ArtBeneficiary removeArtBeneficiary(ArtBeneficiary artBeneficiary) {
		...
		artBeneficiary.setMasterBeneficiaryActivityStatus(null);
