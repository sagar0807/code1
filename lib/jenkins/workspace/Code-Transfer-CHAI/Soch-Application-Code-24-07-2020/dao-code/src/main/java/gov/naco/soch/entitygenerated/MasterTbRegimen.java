...
/**
 * The persistent class for the master_tb_regimen database table.
 * 
 */
@Entity
@Table(name="master_tb_regimen")
@NamedQuery(name="MasterTbRegimen.findAll", query="SELECT m FROM MasterTbRegimen m")
public class MasterTbRegimen implements Serializable {
	...
	public ArtBeneficiaryIptAttDetail addArtBeneficiaryIptAttDetail(ArtBeneficiaryIptAttDetail artBeneficiaryIptAttDetail) {
		...
		artBeneficiaryIptAttDetail.setMasterTbRegimen(this);
	...
	public ArtBeneficiaryIptAttDetail removeArtBeneficiaryIptAttDetail(ArtBeneficiaryIptAttDetail artBeneficiaryIptAttDetail) {
		...
		artBeneficiaryIptAttDetail.setMasterTbRegimen(null);
