...
/**
 * The persistent class for the master_diagnosed_by database table.
 * 
 */
@Entity
@Table(name="master_diagnosed_by")
@NamedQuery(name="MasterDiagnosedBy.findAll", query="SELECT m FROM MasterDiagnosedBy m")
public class MasterDiagnosedBy implements Serializable {
	...
	public ArtBeneficiaryIptAttDetail addArtBeneficiaryIptAttDetail(ArtBeneficiaryIptAttDetail artBeneficiaryIptAttDetail) {
		...
		artBeneficiaryIptAttDetail.setMasterDiagnosedBy(this);
	...
	public ArtBeneficiaryIptAttDetail removeArtBeneficiaryIptAttDetail(ArtBeneficiaryIptAttDetail artBeneficiaryIptAttDetail) {
		...
		artBeneficiaryIptAttDetail.setMasterDiagnosedBy(null);
