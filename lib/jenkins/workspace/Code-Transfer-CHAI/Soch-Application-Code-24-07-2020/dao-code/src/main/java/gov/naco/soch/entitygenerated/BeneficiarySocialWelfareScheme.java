...
/**
 * The persistent class for the beneficiary_social_welfare_schemes database table.
 * 
 */
@Entity
...
public class BeneficiarySocialWelfareScheme implements Serializable {
	...
	public MasterSocialWelfare getMasterSocialWelfare() {
		return this.masterSocialWelfare;
	}
