...
/**
 * The persistent class for the master_tb_result database table.
 * 
 */
@Entity
@Table(name="master_tb_result")
@NamedQuery(name="MasterTbResult.findAll", query="SELECT m FROM MasterTbResult m")
public class MasterTbResult implements Serializable {
	...
	public ArtBeneficiaryIptAttDetail addArtBeneficiaryIptAttDetail(ArtBeneficiaryIptAttDetail artBeneficiaryIptAttDetail) {
		...
		artBeneficiaryIptAttDetail.setMasterTbResult(this);
	...
	public ArtBeneficiaryIptAttDetail removeArtBeneficiaryIptAttDetail(ArtBeneficiaryIptAttDetail artBeneficiaryIptAttDetail) {
		...
		artBeneficiaryIptAttDetail.setMasterTbResult(null);
