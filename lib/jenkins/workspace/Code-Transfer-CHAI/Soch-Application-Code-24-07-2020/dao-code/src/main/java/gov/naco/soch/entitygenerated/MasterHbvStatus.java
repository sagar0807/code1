...
/**
 * The persistent class for the master_hbv_status database table.
 * 
 */
@Entity
@Table(name="master_hbv_status")
@NamedQuery(name="MasterHbvStatus.findAll", query="SELECT m FROM MasterHbvStatus m")
public class MasterHbvStatus implements Serializable {
	...
	@OneToMany(mappedBy="masterHbvStatus")
	...
	public ArtBeneficiaryClinicalDetail addArtBeneficiaryClinicalDetail(ArtBeneficiaryClinicalDetail artBeneficiaryClinicalDetail) {
		...
		artBeneficiaryClinicalDetail.setMasterHbvStatus(this);
	...
	public ArtBeneficiaryClinicalDetail removeArtBeneficiaryClinicalDetail(ArtBeneficiaryClinicalDetail artBeneficiaryClinicalDetail) {
		...
		artBeneficiaryClinicalDetail.setMasterHbvStatus(null);
	...
	public ArtPep addArtPep(ArtPep artPep) {
		...
		artPep.setMasterHbvStatus(this);
	...
	public ArtPep removeArtPep(ArtPep artPep) {
		...
		artPep.setMasterHbvStatus(null);
