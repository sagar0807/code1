 ...
 * 
 */
@GenericGenerator(name = "master_organisation_type", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator", 
parameters = {
		@Parameter(name = "sequence_name", value = "master_organisation_type_id_seq"), 
...
public class MasterOrganisationType implements Serializable {
	...
	@Id
	@GeneratedValue(generator = "master_organisation_type")
	private Long id;
