...
/**
 * The persistent class for the master_vaccine_type database table.
 * 
 */
@Entity
@Table(name="master_vaccine_type")
@NamedQuery(name="MasterVaccineType.findAll", query="SELECT m FROM MasterVaccineType m")
public class MasterVaccineType implements Serializable {
	...
	@OneToMany(mappedBy="masterVaccineType")
	...
	public ArtBeneficiaryImmunizationReport addArtBeneficiaryImmunizationReport(ArtBeneficiaryImmunizationReport artBeneficiaryImmunizationReport) {
		...
		artBeneficiaryImmunizationReport.setMasterVaccineType(this);
	...
	public ArtBeneficiaryImmunizationReport removeArtBeneficiaryImmunizationReport(ArtBeneficiaryImmunizationReport artBeneficiaryImmunizationReport) {
		...
		artBeneficiaryImmunizationReport.setMasterVaccineType(null);
