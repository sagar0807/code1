...
/**
 * The persistent class for the master_clinical_stage database table.
 * 
 */
@Entity
@Table(name="master_clinical_stage")
@NamedQuery(name="MasterClinicalStage.findAll", query="SELECT m FROM MasterClinicalStage m")
public class MasterClinicalStage implements Serializable {
	...
	@OneToMany(mappedBy="masterClinicalStage")
	private Set<ArtBeneficiaryFollowup> artBeneficiaryFollowups;

	public MasterClinicalStage() {
	}
	...
	public ArtBeneficiaryFollowup addArtBeneficiaryFollowup(ArtBeneficiaryFollowup artBeneficiaryFollowup) {
		...
		artBeneficiaryFollowup.setMasterClinicalStage(this);
	...
	public ArtBeneficiaryFollowup removeArtBeneficiaryFollowup(ArtBeneficiaryFollowup artBeneficiaryFollowup) {
		...
		artBeneficiaryFollowup.setMasterClinicalStage(null);
