...
/**
 * The persistent class for the master_training_type database table.
 * 
 */
@Entity
@Table(name="master_training_type")
@NamedQuery(name="MasterTrainingType.findAll", query="SELECT m FROM MasterTrainingType m")
public class MasterTrainingType implements Serializable {
	...
	@OneToMany(mappedBy="masterTrainingType")
	...
	public UserMaster addUserMaster(UserMaster userMaster) {
		...
		userMaster.setMasterTrainingType(this);
	...
	public UserMaster removeUserMaster(UserMaster userMaster) {
		...
		userMaster.setMasterTrainingType(null);
