...
/**
 * The persistent class for the master_tobacco_use database table.
 * 
 */
@Entity
@Table(name="master_tobacco_use")
@NamedQuery(name="MasterTobaccoUse.findAll", query="SELECT m FROM MasterTobaccoUse m")
public class MasterTobaccoUse implements Serializable {
	...
	public ArtBeneficiaryClinicalDetail addArtBeneficiaryClinicalDetail(ArtBeneficiaryClinicalDetail artBeneficiaryClinicalDetail) {
		...
		artBeneficiaryClinicalDetail.setMasterTobaccoUse(this);
	...
	public ArtBeneficiaryClinicalDetail removeArtBeneficiaryClinicalDetail(ArtBeneficiaryClinicalDetail artBeneficiaryClinicalDetail) {
		...
		artBeneficiaryClinicalDetail.setMasterTobaccoUse(null);
