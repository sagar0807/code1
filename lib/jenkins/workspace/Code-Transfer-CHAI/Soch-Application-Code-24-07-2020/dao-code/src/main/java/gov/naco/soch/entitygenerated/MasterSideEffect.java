...
/**
 * The persistent class for the master_side_effects database table.
 * 
 */
@Entity
@Table(name="master_side_effects")
@NamedQuery(name="MasterSideEffect.findAll", query="SELECT m FROM MasterSideEffect m")
public class MasterSideEffect implements Serializable {
	...
	public ArtBeneficiarySideEffect addArtBeneficiarySideEffect(ArtBeneficiarySideEffect artBeneficiarySideEffect) {
		...
		artBeneficiarySideEffect.setMasterSideEffect(this);
	...
	public ArtBeneficiarySideEffect removeArtBeneficiarySideEffect(ArtBeneficiarySideEffect artBeneficiarySideEffect) {
		...
		artBeneficiarySideEffect.setMasterSideEffect(null);
