...
/**
 * The persistent class for the master_dna_pcr_result database table.
 * 
 */
@Entity
@Table(name="master_dna_pcr_result")
@NamedQuery(name="MasterDnaPcrResult.findAll", query="SELECT m FROM MasterDnaPcrResult m")
public class MasterDnaPcrResult implements Serializable {
	...
	public ArtBeneficiaryDnaPcrResult addArtBeneficiaryDnaPcrResult(ArtBeneficiaryDnaPcrResult artBeneficiaryDnaPcrResult) {
		...
		artBeneficiaryDnaPcrResult.setMasterDnaPcrResult(this);
	...
	public ArtBeneficiaryDnaPcrResult removeArtBeneficiaryDnaPcrResult(ArtBeneficiaryDnaPcrResult artBeneficiaryDnaPcrResult) {
		...
		artBeneficiaryDnaPcrResult.setMasterDnaPcrResult(null);
