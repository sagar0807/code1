...
/**
 * The persistent class for the master_dna_pcr_test database table.
 * 
 */
@Entity
@Table(name="master_dna_pcr_test")
@NamedQuery(name="MasterDnaPcrTest.findAll", query="SELECT m FROM MasterDnaPcrTest m")
public class MasterDnaPcrTest implements Serializable {
	...
	public ArtBeneficiaryDnaPcrResult addArtBeneficiaryDnaPcrResult(ArtBeneficiaryDnaPcrResult artBeneficiaryDnaPcrResult) {
		...
		artBeneficiaryDnaPcrResult.setMasterDnaPcrTest(this);
	...
	public ArtBeneficiaryDnaPcrResult removeArtBeneficiaryDnaPcrResult(ArtBeneficiaryDnaPcrResult artBeneficiaryDnaPcrResult) {
		...
		artBeneficiaryDnaPcrResult.setMasterDnaPcrTest(null);
