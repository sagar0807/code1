 ...
 * 
 */
@GenericGenerator(name = "master_hiv_status", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator", 
parameters = {
		@Parameter(name = "sequence_name", value = "master_hiv_status_id_seq"), 
...
public class MasterHivStatus implements Serializable {
	...
	@Id
	@GeneratedValue(generator = "master_hiv_status")
	private Long id;
