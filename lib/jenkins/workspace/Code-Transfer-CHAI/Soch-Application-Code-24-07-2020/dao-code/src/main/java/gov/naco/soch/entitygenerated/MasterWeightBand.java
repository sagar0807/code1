...
/**
 * The persistent class for the master_weight_band database table.
 * 
 */
@Entity
@Table(name="master_weight_band")
@NamedQuery(name="MasterWeightBand.findAll", query="SELECT m FROM MasterWeightBand m")
public class MasterWeightBand implements Serializable {
	...
	@OneToMany(mappedBy="masterWeightBand")
	private Set<ProductDosage> productDosages;

	public MasterWeightBand() {
	}
	...
	public ProductDosage addProductDosage(ProductDosage productDosage) {
		...
		productDosage.setMasterWeightBand(this);
	...
	public ProductDosage removeProductDosage(ProductDosage productDosage) {
		...
		productDosage.setMasterWeightBand(null);
