...
/**
 * The persistent class for the master_four_s_symptom database table.
 * 
 */
@Entity
@Table(name="master_four_s_symptom")
@NamedQuery(name="MasterFourSSymptom.findAll", query="SELECT m FROM MasterFourSSymptom m")
public class MasterFourSSymptom implements Serializable {
	...
	public BeneficiaryFourSSymptomsPerVisit addBeneficiaryFourSSymptomsPerVisit(BeneficiaryFourSSymptomsPerVisit beneficiaryFourSSymptomsPerVisit) {
		...
		beneficiaryFourSSymptomsPerVisit.setMasterFourSSymptom(this);
	...
	public BeneficiaryFourSSymptomsPerVisit removeBeneficiaryFourSSymptomsPerVisit(BeneficiaryFourSSymptomsPerVisit beneficiaryFourSSymptomsPerVisit) {
		...
		beneficiaryFourSSymptomsPerVisit.setMasterFourSSymptom(null);
