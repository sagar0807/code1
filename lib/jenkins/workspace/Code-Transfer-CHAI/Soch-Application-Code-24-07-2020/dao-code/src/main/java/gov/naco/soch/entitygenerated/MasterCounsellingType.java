...
/**
 * The persistent class for the master_counselling_type database table.
 * 
 */
@Entity
@Table(name="master_counselling_type")
@NamedQuery(name="MasterCounsellingType.findAll", query="SELECT m FROM MasterCounsellingType m")
public class MasterCounsellingType implements Serializable {
	...
	@OneToMany(mappedBy="masterCounsellingType")
	private Set<TiBenCounsellingType> tiBenCounsellingTypes;

	public MasterCounsellingType() {
	}
	...
	public TiBenCounsellingType addTiBenCounsellingType(TiBenCounsellingType tiBenCounsellingType) {
		...
		tiBenCounsellingType.setMasterCounsellingType(this);
	...
	public TiBenCounsellingType removeTiBenCounsellingType(TiBenCounsellingType tiBenCounsellingType) {
		...
		tiBenCounsellingType.setMasterCounsellingType(null);
