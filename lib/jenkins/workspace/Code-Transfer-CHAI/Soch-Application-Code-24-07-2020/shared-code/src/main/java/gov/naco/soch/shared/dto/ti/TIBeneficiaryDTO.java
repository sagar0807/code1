...
import gov.naco.soch.shared.dto.FacilityDTO;
...
public class TIBeneficiaryDTO implements Serializable {
	...
	private MiniMasterDto subCategory;
	...
	public MiniMasterDto getSubCategory() {
		return subCategory;
	}

	public void setSubCategory(MiniMasterDto subCategory) {
	...
	public String toString() {
		return "TIBeneficiaryDTO [id=" + id + ", geoLatitude=" + geoLatitude + ", geoLongitude=" + geoLongitude
				...
				+ ", hotspot=" + hotspot + ", sexOtherThanSpouse=" + sexOtherThanSpouse + ", category=" + category
				+ ", beneficiaryActivityStatus=" + beneficiaryActivityStatus + ", beneficiaryType=" + beneficiaryType
				+ ", uid=" + uid + ", benReferredFrom=" + benReferredFrom + ", noOfSexualActivity=" + noOfSexualActivity
				+ ", isActive=" + isActive + ", isDeleted=" + isDeleted + ", lapTreatments=" + lapTreatments
				+ ", ibTreatments=" + ibTreatments + ", masterBeneficiary=" + masterBeneficiary
