...
public class ICTCBeneficiaryDTO implements Serializable {
	...
	public String toString() {
		return "ICTCBeneficiaryDTO [id=" + id + ", pid=" + pid + ", isConsentDocumented=" + isConsentDocumented
				...
				+ beneficiaryId + ", currentTestResultId=" + currentTestResultId + ", relationshipRecordId="
				+ relationshipRecordId + ", relationshipType=" + relationshipType + ", recentVisitId=" + recentVisitId
