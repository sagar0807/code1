...
/**
 * Criteria class for the {@link gov.naco.soch.domain.Referrals} entity. This class is used
 * in {@link gov.naco.soch.web.rest.ReferralsResource} to receive all the possible filtering options from
 ...
 */
public class ReferralsCriteria implements Serializable, Criteria {
    ...
    public ReferralsCriteria(ReferralsCriteria other) {
    ...
    @Override
    public ReferralsCriteria copy() {
        return new ReferralsCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ReferralsCriteria that = (ReferralsCriteria) o;
        return
