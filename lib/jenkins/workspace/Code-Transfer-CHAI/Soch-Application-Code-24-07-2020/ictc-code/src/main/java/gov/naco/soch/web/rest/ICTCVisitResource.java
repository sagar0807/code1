...
public class ICTCVisitResource {
    ...
    private final ICTCVisitQueryService iCTCVisitQueryService;

    public ICTCVisitResource(ICTCVisitService iCTCVisitService, ICTCVisitQueryService iCTCVisitQueryService) {
        this.iCTCVisitService = iCTCVisitService;
        this.iCTCVisitQueryService = iCTCVisitQueryService;
    }
